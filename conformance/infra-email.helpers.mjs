...
process.env.BETTER_AUTH_API_URL = "https://env-mail.example.test/env-base";

export const infraRoot = await import("@better-auth/infra");
export const infraEmail = await import("@better-auth/infra/email");
...
export const envApiBase = "https://env-mail.example.test/env-base/api";
