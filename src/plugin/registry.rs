...
const CORE_ENDPOINTS: &[(PluginHttpMethod, &str)] = &[
    ...
    (PluginHttpMethod::Post, "/admin/remove-user"),
    (PluginHttpMethod::Post, "/admin/set-role"),
    (PluginHttpMethod::Post, "/admin/ban-user"),
    (PluginHttpMethod::Post, "/admin/unban-user"),
    (PluginHttpMethod::Post, "/admin/list-user-sessions"),
    (PluginHttpMethod::Post, "/admin/revoke-user-session"),
