...
use crate::{
    ...
    mongodb::{MongoFindOptions, MongoSort, MongoSortDirection, MongoStore, query::execute},
};
use async_trait::async_trait;

#[async_trait]
impl OAuthProviderResourceStore for MongoStore {
...
fn sorted(field: &str) -> MongoFindOptions {
    MongoFindOptions {
        sort: Some(MongoSort {
            field: field.into(),
