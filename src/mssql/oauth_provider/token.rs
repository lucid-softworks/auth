...
use crate::{
    ...
    mssql::{MssqlFilter, MssqlFindOptions, MssqlStore, query::execute},
};
...
#[async_trait]
impl OAuthProviderTokenStore for MssqlStore {
    ...
    async fn rotate_oauth_refresh_token(
        ...
        execute::update_one(
            ...
            &[
                eq("id", &rotation.previous_refresh_id),
                MssqlFilter::equal("revoked", Value::Null),
            ],
            Map::from_iter([
    ...
    async fn revoke_oauth_refresh_token(
        ...
        let updated = execute::update_one(
            ...
            schema,
            "oauthRefreshToken",
            &[eq("id", id), MssqlFilter::equal("revoked", Value::Null)],
