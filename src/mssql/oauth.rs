use super::{MssqlFilter, MssqlFindOptions, MssqlSort, MssqlSortDirection, MssqlStore, codec};
use crate::{
...
#[async_trait]
impl OAuthAccountStore for MssqlStore {
    ...
    async fn compare_and_swap_oauth_tokens(
        ...
        let filters = [
            ...
            MssqlFilter::equal("refreshToken", json!(expected_refresh_token)),
            MssqlFilter::equal("updatedAt", json!(expected_updated_at)),
        ];
