...
impl TestHelpers<'_> {
    ...
    pub fn create_user(&self, overrides: TestUserOverrides) -> crate::AuthUser {
        crate::test_utils::factory::user(
            self.service.generate_test_id("user"),
    ...
    pub async fn save_user(
        ...
        crate::database_hooks::scope_creation_method("test", async {
            let user = self.service.prepare_forced_user_create(user).await?;
    ...
    pub async fn delete_user(&self, user_id: &str) -> Result<(), TestUtilsError> {
