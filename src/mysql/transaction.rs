...
pub(super) async fn run(
    ...
    let transaction = Arc::new(MySqlHookTransaction {
        store: store.clone(),
...
struct MySqlHookTransaction {
    store: MySqlStore,
    sql: Mutex<Option<Transaction<'static, MySql>>>,
    active: AtomicBool,
}

impl MySqlHookTransaction {
...
#[async_trait]
impl DatabaseTransaction for MySqlHookTransaction {
    async fn find_by_id(
        &self,
        model: DatabaseModel,
        id: &str,
