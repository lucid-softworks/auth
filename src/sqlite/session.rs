use super::{SqliteFilter, SqliteFilterOperator, SqliteStore, codec};
...
pub(super) async fn create(
    ...
    codec::decode("session", store.insert_record("session", record).await?)
}
...
fn eq(field: &str, value: Value) -> SqliteFilter {
    SqliteFilter::equal(field, value)
}
