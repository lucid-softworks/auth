...
fn provider_spec(kind: Kind) -> ProviderSpec {
    match kind {
        ...
        Kind::Reddit => spec!("Reddit", "https://www.reddit.com/api/v1/authorize", "https://www.reddit.com/api/v1/access_token", Some("https://oauth.reddit.com/api/v1/me"), None, &["identity"], &["/id"], &[], &["/name"], &["/icon_img"], &[], None, Some("reddit.placeholder.invalid")),
        Kind::Roblox => spec!("Roblox", "https://apis.roblox.com/oauth/v1/authorize", "https://apis.roblox.com/oauth/v1/token", Some("https://apis.roblox.com/oauth/v1/userinfo"), None, &["openid", "profile"], &["/sub"], &[], &["/nickname", "/preferred_username"], &["/picture"], &[], None, Some("roblox.placeholder.invalid")),
        ...
        Kind::Twitter => spec!("Twitter", "https://x.com/i/oauth2/authorize", "https://api.x.com/2/oauth2/token", Some("https://api.x.com/2/users/me?user.fields=profile_image_url"), None, &["users.read", "tweet.read", "offline.access", "users.email"], &["/id"], &["/email"], &["/name"], &["/profile_image_url"], &[], Some("/data"), Some("twitter.placeholder.invalid")),
        ...
        Kind::Wechat => spec!("WeChat", "https://open.weixin.qq.com/connect/qrconnect", "https://api.weixin.qq.com/sns/oauth2/access_token", Some("https://api.weixin.qq.com/sns/userinfo"), None, &["snsapi_login"], &["/unionid", "/openid"], &[], &["/nickname"], &["/headimgurl"], &[], None, Some("wechat.placeholder.invalid")),
