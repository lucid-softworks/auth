...
| Framework and production installation guides | Supported | Runnable memory/SQLite/PostgreSQL Axum examples, native Cloudflare D1 binding and migration configuration, explicit Cargo/client pins, React/Vue/Svelte/Solid/vanilla and SSR boundaries, plus proxy/TLS/cookie/CORS/migration guidance; [#65](https://github.com/lucid-softworks/auth/issues/65). |
