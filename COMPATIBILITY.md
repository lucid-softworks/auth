...
| Cloudflare D1 | Planned | D1 is not a local SQLite connection and has a different transport, batch, and non-interactive transaction contract; [#96](https://github.com/lucid-softworks/auth/issues/96). |
...
| Framework and production installation guides | Supported | Runnable memory/SQLite/PostgreSQL Axum examples, explicit Cargo/client pins, React/Vue/Svelte/Solid/vanilla and SSR boundaries, plus proxy/TLS/cookie/CORS/migration guidance; [#65](https://github.com/lucid-softworks/auth/issues/65). |
