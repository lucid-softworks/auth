...
| Official JavaScript client conformance | Planned | Existing tests send HTTP requests directly. The real-client harness is [#2](https://github.com/lucid-softworks/auth/issues/2). |
